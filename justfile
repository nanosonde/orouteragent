...
vm_ip := env_var_or_default("E2E_CONTROL_IP", "198.18.0.50")
...
# Exercise registry transforms against native UCI and restore the VM afterward.
e2e-config-smoke: e2e-deploy
    {{e2e}}/scripts/test-config-transforms.sh
